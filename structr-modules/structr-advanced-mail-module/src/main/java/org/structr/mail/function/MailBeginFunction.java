...
public class MailBeginFunction extends Function<Object, Object> {
	...
	public Object apply(ActionContext ctx, Object caller, Object[] sources) throws FrameworkException {
		...
		try {
			...
			if (arrayHasMinLengthAndMaxLengthAndAllElementsNotNull(sources, 1, 6)) {
				...
				switch (sources.length) {
					case 6: {
						if (sources[5] instanceof List && ((List) sources[5]).size() > 0 && ((List) sources[5]).get(0) instanceof FileBase) {
